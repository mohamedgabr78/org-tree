          ...
          <li>
            ...
            <ul>
              <li>
                <div class="user">
                  <img
                    src="https://s3.amazonaws.com/uifaces/faces/twitter/nzcode/128.jpg"
                    class="img-responsive"
                  />
                ...
                <ul>
                  <li>
                    <div class="user">
                      <img
                        src="https://s3.amazonaws.com/uifaces/faces/twitter/towhidzaman/128.jpg"
                        class="img-responsive"
                      />
              ...
              <li>
                <div class="user">
                  <img
                    src="https://s3.amazonaws.com/uifaces/faces/twitter/vista/128.jpg"
                    class="img-responsive"
                  />
